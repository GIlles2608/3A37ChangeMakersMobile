...
public class CoachingGui extends Form {
    ...
    private final RegimeFavoriesService ts = RegimeFavoriesService.getInstance();
    ...
    public CoachingGui() {
        ...
        // fetch the courses
        List<Regime> courses = ts.fetchCourses();

        // add each course to the CoursesListView container
        for (Regime r : courses) {
            listView.addItem(r.getTitre(), r.getDiscription(),r.getListe_alement(), r.getLevel(), new ActionListener() {
                @Override
                public void actionPerformed(ActionEvent evt) {
                     ...
                     * ************************
                     */
                    Label descriptionLabel = new Label(r.getDiscription());
