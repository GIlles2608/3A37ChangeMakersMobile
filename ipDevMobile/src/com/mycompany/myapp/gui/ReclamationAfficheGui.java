...
public class ReclamationAfficheGui extends Form {

    EncodedImage enc;
    Image imgs;
    ImageViewer imgv;

    private final ReclamationService ts = ReclamationService.getInstance();

    public ReclamationAfficheGui() {
        super("course");
  ...
  List<Reclamation> courses = ts.fetchSport();
        // add each course to the CoursesListView container
        for (Reclamation r : courses) {
            listView.addItemSport(r.getTitre_reclamation(), r.getDescription_reclamation(), r.getType_reclamation(), new ActionListener() {
                @Override
                public void actionPerformed(ActionEvent evt) {
                     ...
                     * ************************
                     */
                    Label titleLabel = new Label(r.getTitre_reclamation());
                     ...
                     * ************************
                     */
                    Label descriptionLabel = new Label(r.getDescription_reclamation());
